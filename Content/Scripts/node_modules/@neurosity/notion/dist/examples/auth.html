<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><title>Notion API - Auth Inheritance</title></head><body> <pre>View source</pre> <script src="//www.gstatic.com/firebasejs/7.2.0/firebase-app.js"></script> <script src="//www.gstatic.com/firebasejs/7.2.0/firebase-auth.js"></script> <script src="//www.gstatic.com/firebasejs/7.2.0/firebase-database.js"></script> <script type="module">
